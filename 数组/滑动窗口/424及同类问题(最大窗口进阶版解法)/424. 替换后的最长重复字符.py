...
* 
* 2、我们的目的就是让窗口尽可能扩张, 有K个字符的容错机会, 容错机会肯定要用给map中"出现次数最多的字符"的以外的字符才有机会让窗口扩张，也就是让 "出现次数最多的字符以外的字符" 变成 "出现次数最多的字符"
* 
...
class Solution(object):
    def characterReplacement(self, s, k):
        ...
        while right < len(s):
            ...
            print(f'left is {left}, right is {right}, {s[left: right + 1]}, maxFrequency is {maxFrequency}')
            """ 
