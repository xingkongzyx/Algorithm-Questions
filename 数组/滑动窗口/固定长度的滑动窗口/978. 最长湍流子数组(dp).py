...
# * 2）若湍流数组不成立, 那么我们需要比较 arr[i-1] 与 arr[i] 是否相等来确定 
# * dp[i] 的值。若 arr[i-1] != arr[i],则 dp[i] = 2; 若 arr[i-1] == arr[i],则dp[i]=1。
...
print(Solution().maxTurbulenceSize(arr = [1,1,1,2,2,2,3,3,3,1,1,1,2,2,1,1,1]))
