""" 「」
? 前面的分析很不错: https://leetcode.cn/problems/alien-dictionary/solution/ji-bai-shuang-100zong-jie-liao-yong-tu-l-r1vg/
...
class Solution:
    def alienOrder(self, words: List[str]) -> str:
        ...
        # * abc 排在 ab前面, 也属于非法输入。这种情况, a-> a b->b 不可能, c -> "" 也不可能
        for i in range(len(words) - 1):
            wordOne = words[i]
            wordTwo = words[i + 1]
