...
? 与 496 一脉相承 && 可以理解的动图: https://leetcode.cn/problems/next-greater-element-ii/solution/dong-hua-jiang-jie-dan-diao-zhan-by-fuxu-4z2g/
? 代码: https://leetcode.cn/problems/next-greater-element-ii/solution/dong-hua-yan-shi-dan-diao-zhan-503xia-yi-ke01/
/ 时间复杂度: O(N)，遍历了两次数组；
